...
pub use types::{State, Action};
pub use config::{AIConfig, ModelConfig, TrainingConfig};
pub use state::{AIState, ModelState};
pub use metrics::{Metrics, TrainingMetrics, InferenceMetrics};
...
impl ResourceManager {
    ...
    pub fn new() -> Result<Self> {
        ...
        let thread_pool = rayon::ThreadPoolBuilder::new()
            ...
            .build()
            .map_err(|e| AIError::InitializationError(format!("Failed to create thread pool: {}", e)))?;
...
pub mod utils {
    ...
    pub fn setup_signal_handlers() -> Result<()> {
        ...
        .map_err(|e| AIError::InitializationError(format!("Failed to set up signal handlers: {}", e)))
    }
